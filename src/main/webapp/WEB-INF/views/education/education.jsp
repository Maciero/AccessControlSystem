        ...
        <div class="resume-section-content">
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                ...
                <div class="flex-shrink-0"><span class="text-primary">
                    <fmt:formatDate pattern="MM/yyyy" value="${title.dateFrom}"/> - <fmt:formatDate pattern="MM/yyyy"
                                                                                                    value="${title.dateTo}"/></span>
                </div>
            </div>
            ...
            <form method="post" action='<c:url value="/editEducation/${title.id}"/>'>
            ...
            <form method="post" action='<c:url value="/removeEducation/${title.id}"/>'>
